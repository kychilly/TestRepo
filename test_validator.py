...
def test_destabilizing_driver_branch() -> None:
...
def test_functional_driver_branch() -> None:
...
def test_abstain_branch_amplification() -> None:
...
def test_abstain_branch_silencing() -> None:
...
def test_unconfirmed_branch() -> None:
...
def test_data_deficient_branch_missing_esm1b() -> None:
...
def test_data_deficient_branch_no_usable_stability_evidence() -> None:
...
def test_low_plddt_does_not_block_functional_driver() -> None:
...
def test_low_plddt_blocks_destabilizing_even_with_high_ddg() -> None:
...
if __name__ == "__main__":
    ...
    subprocess.run([sys.executable, "-m", "pytest", str(Path(__file__)), "-v"], check=True)
